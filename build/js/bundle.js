...
const getPlayerAnimationFrames = asset => {
  const frames = {
    idle: [],
    attack: [],
    "attack-2": [],
...
/* harmony export (immutable) */ __webpack_exports__["a"] = getPlayerAnimationFrames;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_pixi__ = __webpack_require__(127);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_pixi___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_pixi__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_p2__ = __webpack_require__(128);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__states_Boot__ = __webpack_require__(339);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__config__ = __webpack_require__(130);
...
class Game extends __WEBPACK_IMPORTED_MODULE_2_phaser___default.a.Game {
  constructor() {
    ...
    super(width, height, __WEBPACK_IMPORTED_MODULE_2_phaser___default.a.CANVAS, "content", null, false);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_webfontloader__ = __webpack_require__(129);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_phaser__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils__ = __webpack_require__(92);
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
  ...
  preload() {
    ...
    const characters = ["cyclop-1", "cyclop-2", "cyclop-3", "golem-1", "golem-2", "golem-3", "necromancer-1", "necromancer-2", "necromancer-3"];

    characters.forEach(character => {
      this.game.load.atlasJSONHash(character, `./assets/sprites/${character}/data.png`, `./assets/sprites/${character}/data.json`);
    });

    const characters2d = ['Barkeep', 'dragon', 'grave_digger', 'mage', 'medium', 'minstrel', 'rogue', 'Scullery Maid', 'swashbuckler', 'warlock', 'warpriest'];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_phaser__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__sprites_Player__ = __webpack_require__(342);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sprites_2dPlayer__ = __webpack_require__(343);
/* globals __DEV__ */
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
  ...
  create() {
    this.loadFakeData();
    this.characters = ["cyclop-1", "cyclop-2", "cyclop-3", "golem-1", "golem-2", "golem-3", "necromancer-1", "necromancer-2", "necromancer-3"];
  ...
  addPlayer(asset, player, stats, position) {
    const _player = new __WEBPACK_IMPORTED_MODULE_2__sprites_2dPlayer__["a" /* default */]({
      game: this.game,
      x: position === "left" ? this.world.centerX - 150 : this.world.centerX + 150,
    ...
    for (const round of data) {
      if (round.action === 'arrange-players') {
        ...
        for (const player of round.meta.players) {
          ...
          this.addPlayer(player.class.name, player, null, player.team === 0 ? 'left' : 'right');
        }
      } else {
        setTimeout(() => {
          switch (round.action) {
...
/* unused harmony default export */ var _unused_webpack_default_export = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Sprite {
  ...
  createHealthBar() {
    this.health = this.game.add.image(this.leftOrRight === "right" ? this.x + 10 : 30, this.y, "health_good");
  ...
  createAnimations() {
    ...
    const frames = Object(__WEBPACK_IMPORTED_MODULE_1__utils__["a" /* getPlayerAnimationFrames */])(this.animations);
    // Add animations
  ...
  createTextHandler(txt) {
    const x = this.leftOrRight === "left" ? this.x + 50 : this.x + this.width / 2 - 50;
    ...
    this.game.add.tween(banner).to({
      y: -5
    }, 2000, __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Easing.Linear.None, true);
    setTimeout(() => {
      banner.destroy();
    }, 1500);
  }
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Sprite {
  ...
  createHealthBar() {
    ...
    this.healthBarBase = this.game.add.image(x, this.y + this.height / 2, "health_bg");
    ...
    this.healthBar = this.game.add.image(x, this.y + this.height / 2, "health_bg");
  ...
  createTextHandler(txt, side = 'left') {
    ...
    this.game.add.tween(banner).to({
      y: -banner.height
    }, 1000, __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Easing.Linear.None, true);
    setTimeout(() => {
      banner.destroy();
    }, 1500);
  }
